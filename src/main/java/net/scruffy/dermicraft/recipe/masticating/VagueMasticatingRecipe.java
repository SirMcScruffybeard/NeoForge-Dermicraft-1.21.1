...
public record VagueMasticatingRecipe(Ingredient ingredientItem, Fluid ingredientFluid,
                                     Fluid result) implements Recipe<VagueMasticatingRecipeInput> {
    ...
    @Override
    public boolean matches(VagueMasticatingRecipeInput input, Level level) {
    ...
    public boolean matches(Level level, ItemStack stack, FluidStack fluidStack) {
        return matches(new VagueMasticatingRecipeInput(stack, fluidStack), level);
    }
    ...
    @Override
    public ItemStack assemble(VagueMasticatingRecipeInput vagueMasticatingRecipeInput, HolderLookup.Provider provider) {
