 ...
 * {@code dermicraft-gadget-notes.md}. Chain slot (materialize/install round-trip) and fuel
 * gauge/fill slot only for now; the completed-swap costs (movement penalty, Scrench durability
 * wear) aren't wired up yet -- see the class's TODO note near {@link #removed}.
 *
...
public class ScrenchMenu extends AbstractModMenu {
     ...
     *
     * <p>TODO: apply the movement-speed penalty and 1-point Scrench durability wear here on a
     * completed install -- deliberately not built yet, this pass is just the chain/fuel
     * mechanics themselves. Cursor-held-item-drops-on-close is already vanilla's own default
     * {@code AbstractContainerMenu} behavior, nothing to add for that case.
     */
    @Override
