...
#### Evolution Module family (design decided 2026-08-19/20, not yet built)
...
- Masticator's own Evolution Module is confirmed in direction (hazard tolerance, additive to its Safety Module, resolving into a real Tier 2) but not designed in any detail yet -- what it's upgraded from, its threshold, whether Tier 2 Masticator gets a name/model/anything beyond "the Molten fluids now work." Effluentcer's and Metastasizer's are even further out -- "likely," not designed at all.
